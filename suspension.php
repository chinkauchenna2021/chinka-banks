    ...
    <div class="page">
        ...
        <section class="section one-screen-page bg-primary-dark">
            ...
            <div class="one-screen-page-inner">
                                  ...
                                  <li class="rd-nav-item d-flex justify-content-center mt-3">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-9 col-lg-7 col-xl-6">
                                <div class="one-screen-page-box">
                                    <div class="page-title">403</div>
                                    <h1 class="page-subtitle">User Accout Have Been Suspended</h1>
                                    <p class="heading-6 page-description">For more Enquires please contact +1-385-3441-822 or via our Official Email : contact@tbsbplc.com.</p><a class="button button-lg button-primary" href="index.php">Back to home page</a>
                                </div>
                            </div>
                        </div>
                    </div>
