    ...
    <div class="page">
        ...
        <section class="section section-bredcrumbs" id="moveup">
            ...
            <div class="container context-dark breadcrumb-wrapper">
                <h1 class="title-c" style="margin-top:-30px">History</h1>
                ...
                <div class="row justify-content-center align-items-center d-flex">
                    ...
                    <!-- <div class="col-12" style="height: 70px;margin-top:50px">
                        <div class="col-12" style="font-weight: bolder; color:rgb(75, 75, 75);font-size: 25px;">
                            <span><i class="fas fa-wallet"></i><span style="margin-left: 2px;margin-right: 5px;">$</span>50,000.00</span>
        ...
        <section style="margin-top: 0px;margin-bottom: 70px; ">
            ...
            <div class="col mt-4 " style="height:10px;display:flex;justify-content: center;margin-top: 80px;padding-bottom:10px ">
                <div style="width:100%;height:100%; font-size: 23px;font-weight:bolder "><i class="fas fa-lock " style="margin-right:5px "></i>
                    <span style="font-size: 20px;font-weight: bolder; ">Transaction History</span></div>
            </div>
...
?>
              ...
              <?php  endwhile ; ?>  
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 d-flex align-items-center justify-content-center" style="height:200px;margin-bottom: 40px;">
            ...
            <div class="container mb-0">
                <div class="row row-40 wow fadeIn  d-flex justify-content-around align-items-center" style="margin-top: -20px;">
                    ...
                    <div class="col-2">
                        ...
                        <h4 style="font-size: 12px;color:#ffffff"> <a class="rd-nav-link" href="user-history.php"><i class="fas fa-history active_dash" style="font-size: 30px;font-weight: bold;"></i><span style="margin-left:-7px">History</span></a></h4>

                    </div>
                    <div class="col-2">
                       <form method="POST" action="user-history.php">
                       <h4 style="font-size: 12px;color:#ffffff;"><a class="rd-nav-link" href="user-history.php?logout=true" ><i class="fas fa-sign-out-alt" style="font-size: 30px;font-weight: bold;"></i><span style="margin-left:-7px">Logout</span></a></h4>
                      </form>
