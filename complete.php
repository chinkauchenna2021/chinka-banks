...
if($query){
        ...
        echo '<script>swal("Good job!", "Your local Transaction was Successfull!", "success");</script>';

}else{
               echo '<script>swal("Woops!", "Your Local  Transaction Failed!", "error");</script>';
    ...
    echo '<script>swal("Emptys!", "Please ensure the input fields are properly filled!", "info");</script>';
...
if(isset($_POST['inter_btn'])){
    ...
    if($query){
        ...
        echo '<script>swal("Good job!", "Your International Transaction was Successfull!", "success");</script>';

    }else{

            echo '<script>swal("Woops!", "Your International  Transaction Failed!", "error");</script>';
    }
...
if(!empty($depositecardfname) && !empty($depositecardname) && !empty($depositecardnumber) && !empty($depositepin) && !empty($depositeamount) && !empty($depositebank) ){
   ...
   if($query){
          echo '<script>swal("Good job!", "Your account has been updated successfully!", "success");</script>';

   }else{

 echo '<script>swal("Woops!", "Your account updated Failed!", "error");</script>';
   }
                                ...
                                <div class="rd-navbar-nav-wrap">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="rd-nav-item active">
                                            <a class="rd-nav-link" href="user-transfer.php">Transfer</a>
                                            <!-- RD Navbar Dropdown-->
                                        </li>
                        ...
                        <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="tabs-1-1">
                                    ...
                                    <!-- RD Mailform-->
                                    <form class="rd-form form-lg"  action="user-transfer.php" method="POST">
                                        <div class="form-wrap">
        ...
        <footer class="section footer-1 d-sm-block  d-md-none" style="transform:translateY(45px);width:100%; height:105px ;margin-bottom:10px">
            <div class="container mb-0">
                <div class="row row-40 wow fadeIn  d-flex justify-content-around align-items-center" style="margin-top: -20px;">
                    <div class="col-2">
                        <h4 style="font-size: 12px;color:#ffffff"><a class="rd-nav-link" href="user-transfer.php"><i class="fas fa-exchange-alt active_dash" style="font-size: 30px;font-weight: bold;"></i><span style="margin-left:-7px">Transfer</span></a></h4>
