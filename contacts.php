                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        ...
                        <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-1-1" data-toggle="tab">United Kingdom</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-2" data-toggle="tab">Singapore</a></li>
                                <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-1-3" data-toggle="tab">United States</a></li>
                            </ul>
                            <!-- Tab panes-->
                                    ...
                                    <ul class="contact-box">
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                                ...
                                                <div class="unit-body"><a class="hover-text" href="#">17 Guildry Street, <br class="veil reveal-lg-inline">Garsdon, United Kingdom</a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                                ...
                                                <div class="unit-body">
                                                    <ul class="list-phones">
                                                        <li><a class="hover-text" href="tel:#">+1-385-3441-822</a></li>
                                                        <li><a class="hover-text" href="tel:#">+1-385-3441-822</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                                ...
                                                <div class="unit-body"><a class="hover-text" href="mailto:#">contact@Tbsbplc.com</a></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                <div class="tab-pane fade" id="tabs-1-2">
                                    <ul class="contact-box">
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                                <div class="unit-left"><span class="icon fa fa-map-marker"></span></div>
                                                <div class="unit-body"><a class="hover-text" href="#">12 Ubi Crescent CORE D, <br class="veil reveal-lg-inline">#02-62 Ubi Techpark, Singapore</a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                ...
                                <div class="tab-pane fade" id="tabs-1-3">
                                    <ul class="contact-box">
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                                                <div class="unit-left"><span class="icon fa fa-map-marker"></span></div>
                                                <div class="unit-body"><a class="hover-text" href="#">5442 Central Street, <br class="veil reveal-lg-inline">Chicago, IL 43541-3243 USA</a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="unit unit-horizontal unit-spacing-xxs">
                        ...
                        <div class="group group-middle social-items">
                            <a class="icon icon-md icon-gray-400 novi-icon fa fa-facebook-official" href="#"></a>
                            <a class="icon icon-md icon-gray-400 novi-icon fa fa-twitter-square" href="#"></a>
                            <a class="icon icon-md icon-gray-400 novi-icon fa fa-instagram" href="#"></a>
                            <!--<a class="icon icon-md icon-gray-400 novi-icon mdi mdi-facebook-messenger" href="#"></a>-->
                            <a class="icon icon-md icon-gray-400 novi-icon fa fa-linkedin-square" href="#"></a>
                            <a class="icon icon-md icon-gray-400 novi-icon fa fa-snapchat-square" href="#"></a>
                        </div>
                    </div>
