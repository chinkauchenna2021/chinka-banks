        ...
        <section class="section section-lg custom-image-section">
            <div class="container relative-container">
                <div class="row row-30 row-md-60 justify-content-between">
                    ...
                    <div class="col-md-6">
                        <div class="heading-6">Tbsbplc is one of the world’s largest banking and financial services organisations. We serve more than 40 million customers through our global businesses: Wealth and Personal Banking, Commercial Banking, and Global Banking & Markets. Our network covers 64 countries and territories in Europe, Asia, the Middle East and Africa, North America and Latin America.</div>
                        <p>Our purpose – Opening up a world of opportunity – explains why we exist. We’re here to use our unique expertise, capabilities, breadth and perspectives to open up new kinds of opportunity for our customers. We’re bringing together the people, ideas and capital that nurture progress and growth, helping to create a better world – for our customers, our people, our investors, our communities and the planet we all share.

Listed on the London, Hong Kong, New York and Bermuda stock exchanges, shares in Tbsbplc Holdings plc are held by around 194,000 shareholders in 130 countries and territories.
                            <!-- </p><a class="button button-lg button-primary" href="services.php">Read More About Us</a> -->
                    </div>
                    <div class="col-md-6 col-lg-5">
                        <div class="progress-linear-wrap">
                            ...
                            <article class="progress-linear">
                                <div class="progress-header">
                                    <p>Online Banking</p><span class="progress-value">75</span>
                                </div>
                                <div class="progress-bar-linear-wrap">
                                    <div class="progress-bar-linear"></div>
                                </div>
                            ...
                            <article class="progress-linear">
                                <div class="progress-header">
                                    <p>24/7 Support</p><span class="progress-value">75</span>
                                </div>
                                <div class="progress-bar-linear-wrap">
                                    <div class="progress-bar-linear"></div>
                                </div>
                ...
                </div><img class="img-bordered image-item" src="images/about-1-470x312.jpg" alt="" width="470" height="312" />
            </div>
        </section>
