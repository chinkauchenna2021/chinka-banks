...
if(isset($_POST['nation_btn'])){
$country = $_POST['nation_country'];
$region = $_POST['nation_region'];
$state = $_POST['nation_region'];
$address = $_POST['nation_address'];
$kin = $_POST['nation_kin'];
$phone = $_POST['nation_phone'];

if(!empty($country) && !empty($region) && !empty($state) && !empty($address) && !empty($kin) && !empty($phone)){
...
$_SESSION['second_reg']="second_reg";
echo "<script>window.open('security-question.php','_self')</script>";
}else{

echo "<script>alert('please fill the inpute correctly')</script>";
                            ...
                            <div class="col-md-10 col-lg-8 col-xl-4">
                                ...
                                <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-inline">
                                        <li class="nav-item" role="presentation"><a class="nav-link " href="#tabs-1-2" data-toggle="tab">Login</a></li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" href="#tabs-1-1" data-toggle="tab">Registration</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link " href="login.php" data-toggle="tab">Back</a>
                                        </li>
                                    </ul>
                                    <!-- Tab panes-->
                                    <div class="tab-content mt-4">
                                        <div class="tab-pane fade " id="tabs-1-2">
                                            <h3>Login</h3>
                                            <!-- RD Mailform-->
                                            <form class="rd-form form-lg " action="register-nation.php" method="POST">
                                                <div class="form-wrap">
                                                ...
                                                <button class="button button-lg button-round button-block button-primary" type="submit" name="log_btn">login</button>
                                            </form>
                                        ...
                                        <div class="tab-pane fade show  active" id="tabs-1-1">
                                            <h3>Customers Destination</h3>
                                            <!-- RD Mailform-->
                                            <form class="rd-form form-lg" action="register-nation.php" method="POST">
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-name" type="text" name="nation_country" data-constraints="@Required">
                                                    <label class="form-label" for="register-name">Enter Country</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-r-name" type="text" name="nation_region" data-constraints="@Required">
                                                    <label class="form-label" for="register-r-name">Enter Region</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-s-name" type="text" name="nation_state" data-constraints="@Required">
                                                    <label class="form-label" for="register-s-name">Enter State</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-d-name" type="text" name="nation_address" data-constraints="@Required">
                                                    <label class="form-label" for="register-d-name">Enter Destination Address</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-k-name" type="text" name="nation_kin" data-constraints="@Required">
                                                    <label class="form-label" for="register-k-name">Enter Next-of-Kin (Name)</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-pn-name" type="text" name="nation_phone" data-constraints="@Required">
                                                    <label class="form-label" for="register-pn-name">Enter your Phonenumber</label>
                                                </div>
                                                <button class="button button-lg button-round button-block button-primary" name="nation_btn" type="submit">Register</button>
                                            </form>
                                            <div class="group-sm group-sm-justify group-middle social-items"><span>or use</span>
                                                <a class="icon icon-lg icon-gray-100 novi-icon fa fa-facebook" href="#"></a>
                                                <a class="icon icon-lg icon-gray-100 novi-icon fa fa-twitter" href="#"></a>
