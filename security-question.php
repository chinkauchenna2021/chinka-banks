...
$resec = $_POST['resec_code'];

$fname = $_SESSION['fname']; 
$pass = $_SESSION['pass']; 
$email = $_SESSION['email'];
$img = $_SESSION['realname'];
...
if(isset($fname) && isset($pass) && isset($email) && isset($img) && isset($country)&& isset($region) && isset($state) && isset($address) && isset($kin) && isset($phone) )
{

if(!empty($seccode) && !empty($resec) && (strlen($seccode) == strlen($resec))){
   
$numb = rand(1000000000,9999999999);

$acc_number = str_shuffle($numb);


$sql = "INSERT INTO `customer_reg`(`id`, `fname`, `email`, `pass`, `img`,`country`, `region`, `state`, `address`, `kin`, `phone`,`security`, `active`,`acc_number`) VALUES ('','$fname','$email','$pass','$img','$country','$region','$state','$address','$kin','$phone','$seccode',1,'$acc_number')";
...
if($query){
    ...
    echo json_encode(array('Failed'=>'did not send to the database'));

}

    // INSERT INTO `customer_reg`(`id`, `fname`, `email`, `pass`, `img`, `country`, `region`, `state`, `address`, `kin`, `phone`, `security`, `active`, `timeofreg`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]','[value-11]','[value-12]','[value-13]','[value-14]')


}else{

echo "this input is very important.Please fill it correctly";
echo json_encode(array('Failed'=>'not sent'));
    ...
    echo "other part of this registration form has not been completed";
                            ...
                            <div class="col-md-10 col-lg-8 col-xl-4">
                                ...
                                <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-1">
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-inline">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" href="register-nation.php" data-toggle="tab">Back</a>
                                        </li>
                                    </ul>
                                    <!-- Tab panes-->
                                    <div class="tab-content">
                                        <div class="tab-pane fade " id="tabs-1-2">
                                            ...
                                            <form class="rd-form form-lg rd-mailform">
                                                ...
                                                <button class="button button-lg button-round button-block button-primary" name="log_btn" type="submit">Register</button>
                                            </form>
                                        ...
                                        <div class="tab-pane fade show  active" id="tabs-1-1">
                                            <h3>Secret Security Code</h3>
                                            <!-- RD Mailform-->
                                            <form class="rd-form form-lg " action="security-question.php" method="POST">
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-name" type="text" name="sec_code" data-constraints="@Required">
                                                    <label class="form-label" for="register-name">Enter Eight digit secret code only know to you</label>
                                                </div>
                                                <div class="form-wrap">
                                                    <input class="form-input" id="register-name" type="text" name="resec_code" data-constraints="@Required">
                                                    <label class="form-label" for="register-name">Re-enter Secret code</label>
                                                </div>

                                                <button class="button button-lg button-round button-block button-primary" name="sec_code_btn" type="submit">Verify</button>
                                            </form>
                                            <div class="group-sm group-sm-justify group-middle social-items"><span>or use</span>
                                                <a class="icon icon-lg icon-gray-100 novi-icon fa fa-facebook" href="#"></a>
                                                <a class="icon icon-lg icon-gray-100 novi-icon fa fa-twitter" href="#"></a>
